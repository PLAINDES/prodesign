									...
									<Grid container spacing={{ xs: 2, sm: 3 }}>
										...
										{vertices.length > 0 && (
											<>
												...
												<Grid xs={12}>
													{/* [DOCUMENTACIÓN] Se eliminaron los botones duplicados 'Generación del terreno' y 'Generación del cuadrante máximo' al pie del formulario por solicitud del usuario */}
		...
		<Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, width: '100%', mb: 2 }}>
			...
			>
				...
				<Box sx={{
					...
					<MuiTooltip title="Restablecer vista">
