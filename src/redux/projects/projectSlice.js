...
export const projectSlice = createSlice({
	...
	reducers: {
		...
		updateProject: (state, { payload }) => {
			// [DOCUMENTACIÓN] Modificación para actualizar nombre, cliente y manager (responsable) de un proyecto en el estado de redux.
			state.projects = state.projects.map(el => el.id === payload.id ? { ...el, ...payload } : el);
		},
...
export const { setProjects, addProject, deleteProject, updateProject, setTypeProjects, setCostsProject, updateProjectCosts,
